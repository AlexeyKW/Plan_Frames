...
SOURCES = \
	__init__.py \
	plan_frames.py plan_frames_dialog.py

PLUGINNAME = plan_frames

PY_FILES = \
	__init__.py \
	plan_frames.py plan_frames_dialog.py

UI_FILES = plan_frames_dialog_base.ui
...
QGISDIR=C:\Users\Alexey\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
